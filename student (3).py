...
def user_input_features():
  # Entrada
  horas_estudiando = st.number_input('Horas estudiando',  )
  horas_durmiendo = st.number_input('Horas durmiendo:', )
  asistencia = st.number_input('Asistencia', )
  calificaciones_anteriores = st.number_input('Calificaciones', )
